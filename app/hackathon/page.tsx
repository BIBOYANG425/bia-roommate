    ...
    <div className="min-h-screen bg-[#0d1117] text-[#e6edf3]">
        ...
        <div className="max-w-[720px] mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-[12px] text-[#484f58]">
            <span
              ...
              style={{ fontFamily: "'Menlo','SF Mono',monospace" }}
            >
              hackathon-recap.md
            </span>
            <span
      ...
      <main>
        <article
          ...
          style={{ fontFamily: "'Menlo','SF Mono','Courier New',monospace" }}
        >
          {/* ─── Hero ─── */}
          <section className="relative overflow-hidden">
            ...
            >
              <p className="text-[11px] tracking-[4px] mb-2 font-bold text-[#3fb950]">
                {"// HACKATHON RECAP"}
              </p>
              <p className="text-[13px] text-[#8b949e]">
                MARCH 28, 2026 · USC · LOS ANGELES
              </p>
            </div>
          </section>
          ...
          <header className="px-6 pt-10 pb-8 border-b border-[#30363d]">
            <div
              className="flex items-center gap-3 mb-6 text-[12px] text-[#8b949e]"
            ...
            <h1
              className="text-[32px] sm:text-[36px] font-black mb-4 leading-tight"
              style={{
                fontFamily:
            ...
            <p
              className="text-[22px] sm:text-[26px] font-bold mb-6 leading-snug text-[#3fb950]"
              style={{
                fontFamily:
                  "'PingFang SC','Hiragino Sans GB','Microsoft YaHei',sans-serif",
              }}
            ...
            <div className="flex items-center gap-3 text-[13px] text-[#8b949e]">
              <span
                className="inline-block bg-[#1c2128] border border-[#30363d] rounded px-2 py-0.5 text-[#e3b341] text-[11px]"
          ...
          <nav className="px-6 py-5 border-b border-[#30363d] bg-[#161b22]/50">
            <p className="text-[11px] tracking-[3px] mb-3 font-bold text-[#484f58] uppercase">
              Contents
            </p>
            <div className="flex flex-wrap gap-x-6 gap-y-1 text-[13px]">
              {[
                ...
                <a
                  ...
                  className="text-[#58a6ff] hover:text-[#79c0ff] transition-colors py-2 inline-block min-h-[44px] flex items-center"
                >
                  {item}
                </a>
              ))}
          ...
          <section
            id="what-happened"
            className="px-6 py-10 border-b border-[#30363d]"
          >
            <p className="text-[11px] tracking-[4px] mb-5 font-bold text-[#3fb950]">
              {"// WHAT HAPPENED"}
            </p>
            <p
            ...
            <p
              className="mb-4 text-base leading-relaxed text-[#8b949e]"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              不是PPT。不是概念图。
              <br />
            ...
            <figure className="my-8">
              ...
              <figcaption
                className="mt-2 text-[12px] text-[#484f58] text-center"
                style={{ fontFamily: "'PingFang SC',sans-serif" }}
              >
                全场60位参赛者在USC现场
              </figcaption>
            ...
            <p
              className="mt-2 text-[#8b949e] text-base"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              我们得到了答案。
            </p>
          ...
          <section
            ...
            className="px-6 py-10 border-b border-[#30363d]"
          >
            <p className="text-[11px] tracking-[4px] mb-6 font-bold text-[#3fb950]">
              {"// THE NUMBERS"}
            </p>
            <div className="grid grid-cols-2 gap-px bg-[#21262d] rounded-lg overflow-hidden">
              {STATS.map((s) => (
                <div key={s.label} className="bg-[#0d1117] p-6">
                  ...
                  <p
                    className="text-[13px] text-[#8b949e] mt-2"
                    style={{ fontFamily: "'PingFang SC',sans-serif" }}
                  >
                    {s.label}
                  </p>
          ...
          >
            <p className="text-[11px] tracking-[4px] mb-5 font-bold text-[#3fb950]">
              {"// BUILD WITH TRAE × MINIMAX"}
            </p>
            <p
              className="mb-4 text-base leading-relaxed"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              每支队伍基于 <strong className="text-[#3fb950]">Trae.ai</strong>{" "}
              开发——一个真正把AI Agent融入每一行代码的IDE。
            </p>
            <p
              className="mb-6 text-base leading-relaxed"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              调用 <strong className="text-[#F4347F]">MiniMax</strong>{" "}
              的多模态API——文本、视觉、语音、视频，全部拉满。
            </p>
            ...
            <p
              className="text-[#8b949e] mb-1 text-base"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              不是在学怎么用AI。
            </p>
          ...
          >
            ...
            <p
              className="mb-6 text-base text-[#8b949e] leading-relaxed"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              来自 Trae 和 MiniMax
              的技术负责人到场，带参赛者快速了解工具能力，直接上手。
            </p>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#1c2128] border border-[#30363d] rounded-lg overflow-hidden">
                <div className="px-4 py-3 border-b border-[#30363d]">
                  <span className="text-[11px] font-bold tracking-[2px] text-[#bc8cff]">
                    ⚡ PHOTON.CODES 专项赛道
                  </span>
                </div>
                <Image
          ...
          >
            ...
            <p
              className="mt-5 text-[13px] text-[#8b949e]"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              特别感谢 <strong className="text-[#e6edf3]">Gary Qi</strong>{" "}
              从筹备到落地的全程支持。
            </p>
          </section>
          ...
          <section className="px-6 py-10 border-b border-[#30363d]">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {PARTNERS.map((p) => (
                <span
                  key={p}
                  className="bg-[#1c2128] border border-[#30363d] rounded-full px-4 py-2 text-[13px]"
                  style={{ fontFamily: "'PingFang SC',sans-serif" }}
                >
                  {p}
                </span>
          ...
          <section className="px-6 py-10 border-b border-[#30363d]">
            ...
            <p
              ...
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              你花了24小时，写了代码，交了产品，站上去做了展示。
            </p>
            <p
              className="mb-6 text-base leading-relaxed text-[#8b949e]"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              很多人想了一年的事情，你用一天做完了。
            </p>
            ...
            <figure className="my-8">
              <div className="border border-[#30363d] rounded-lg overflow-hidden">
                ...
                <div className="px-4 py-2.5 bg-[#1c2128]">
                  <p
                    className="text-[12px] text-[#8b949e]"
                    style={{ fontFamily: "'PingFang SC',sans-serif" }}
                  >
                    BIA 组织团队 & USC SESE
                  </p>
          ...
          <section className="px-6 py-12 border-b border-[#30363d] text-center">
            ...
            <p
              className="mb-6 text-[#8b949e] text-base"
              style={{ fontFamily: "'PingFang SC',sans-serif" }}
            >
              下一场，已经在路上了。
            </p>
          ...
          <footer className="px-6 py-10 bg-[#161b22]">
            ...
            <div className="mt-8 pt-6 border-t border-[#21262d] text-center">
              <p
                className="text-[12px] text-[#484f58]"
                style={{ fontFamily: "'PingFang SC',sans-serif" }}
              >
                关注我们，不错过下一场。
              </p>
