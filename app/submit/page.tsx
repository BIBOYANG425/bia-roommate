...
export default function SubmitPage() {
  ...
  if (submittedProfileId) {
    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--beige)' }}>
        <div
        ...
        >
          ...
          <h2 className="font-display text-3xl tracking-wider mb-2" style={{ color: 'var(--black)' }}>
            PROFILE DROPPED
          </h2>
          <p className="text-sm mb-6" style={{ color: 'var(--mid)' }}>
            Create an account to edit your profile later and save course schedules.
          </p>
