...
function getNextColorIndex(usedIndices) {
...
function parseSectionTimes(times) {
  const slots = [];
...
function buildCombos(course) {
  ...
  const requiredTypes = types.filter(
    (t) => byType[t].some((s) => s.slots.length > 0)
  );
  if (requiredTypes.length === 0) return [];
  const combos = [];
  function generate(typeIdx, current, currentSlots) {
    ...
    for (const entry of byType[requiredTypes[typeIdx]]) {
      ...
      const hasInternalConflict = entry.slots.some(
        (a) => currentSlots.some((b) => slotsConflict(a, b))
      );
...
function optimizeSchedule(groups) {
  let bestScore = -1;
  let bestSections = [];
  ...
  const current = [];
  const currentSlots = [];
  function backtrack(idx, score) {
    if (Date.now() - startTime > 1e4) return;
    ...
    if (score + remaining * 5 * 3 <= bestScore) return;
    for (const combo of gc.combos) {
      const hasConflict = combo.allSlots.some(
        (a) => currentSlots.some((b) => slotsConflict(a, b))
      );
      ...
      const newEntries = combo.sections.map((entry) => ({
        courseId,
...
function MiniCalendar({ sections }) {
  if (sections.length === 0) return null;
  const grid = HOURS.map(() => DAYS.map(() => null));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mini-calendar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mini-calendar-header" }),
    DAYS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mini-calendar-header", children: d }, d)),
    HOURS.map((h, ri) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mini-calendar-time", children: [
        h > 12 ? h - 12 : h,
        h >= 12 ? "p" : "a"
      ] }),
      DAYS.map((_, ci) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: color ? { backgroundColor: color.bg } : void 0,
            title: sec ? `${sec.courseId} ${sec.courseTitle}` : void 0
          },
          `${ri}-${ci}`
        );
      })
...
function ScheduleOptimizer() {
  const [courseCodes, setCourseCodes] = reactExports.useState([]);
  const [selectedGEs, setSelectedGEs] = reactExports.useState(/* @__PURE__ */ new Set());
  const [optimizedSections, setOptimizedSections] = reactExports.useState([]);
  ...
  const handleOptimize = reactExports.useCallback(async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "My Courses" }),
    courseCodes.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 12, display: "flex", flexWrap: "wrap", gap: 4 }, children: courseCodes.map((code) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        className: "match-tag",
      ...
      code
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 11, color: "#8C7E6A", marginBottom: 12, fontWeight: 600 }, children: "Open myCourseBin on WebReg to load your courses." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "GE Requirements" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4, marginBottom: 16 }, children: GE_CATEGORIES.map((ge) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "label",
      {
        style: {
          display: "flex",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: ge.code }),
            " ",
            ge.name
          ] })
        ]
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-text", children: status || "Loading..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: "Build Best Schedule"
      }
    ),
    optimizedSections.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "section-title", style: { marginTop: 16 }, children: [
        "Optimal Schedule (",
        optimizedSections.length,
        " sections)"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MiniCalendar, { sections: optimizedSections }),
      optimizedSections.map((sec) => {
        ...
        const instrName = instructor?.firstName ? `${instructor.firstName} ${instructor.lastName}` : instructor?.lastName || "TBA";
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "course-card-id",
                style: { color: color.bg === "#1A1410" ? "#FFCC00" : color.bg },
                children: sec.courseId
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 11, color: "#8C7E6A" }, children: [
              sec.section.type,
              " · ",
              sec.units,
              " units"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "course-card-title", children: sec.courseTitle }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card-meta", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: instrName }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              sec.section.registered,
              "/",
              sec.section.capacity,
              " seats"
            ] })
          ] })
        ] }, `${sec.courseId}-${sec.section.id}`);
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: "Open full planner for more options →"
        }
      )
    ] })
  ] });
...
function InterestSearch() {
  ...
  const [loading, setLoading] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const [semester, setSemester] = reactExports.useState("20263");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "What are you interested in?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-tags", children: QUICK_TAGS.map((tag) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: loading ? "Searching..." : "Find Matching Courses"
      }
    ),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-fill", style: { width: "60%" } }) }),
    recommendations.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "section-title", children: [
        "Found ",
        recommendations.length,
        " courses for you"
      ] }),
      recommendations.map((rec) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "course-card-id", children: [
            rec.department,
            " ",
            rec.number
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noopener noreferrer",
              children: "Open in WebReg →"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "course-card-title", children: rec.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "course-card-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            rec.units,
            " units"
          ] }),
          rec.geTag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ge-tag", children: rec.geTag })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4 }, children: rec.matchReasons.map((reason) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "match-tag", children: reason }, reason)) })
...
function Settings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Features" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "RMP Ratings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-description", children: "Show professor ratings next to names" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Conflict Highlights" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-description", children: "Highlight time conflicts on WebReg" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Seat Counts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-description", children: "Show enrollment badges on sections" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", style: { marginTop: 16 }, children: "Semester" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "20261", children: "Spring 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "20262", children: "Summer 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "20263", children: "Fall 2026" })
        ]
      }
    ),
    saved && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", marginTop: 12, color: "#990000", fontSize: 12, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Settings saved" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 24, textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          className: "link-button",
          ...
          target: "_blank",
          rel: "noopener noreferrer",
          children: "Open BIA Course Planner →"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 10, color: "#8C7E6A", marginTop: 8, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }, children: "BIA Course Helper v1.0.0" })
    ] })
  ] });
}

function App() {
  const [activeTab, setActiveTab] = reactExports.useState("optimizer");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "popup-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "popup-title", children: "BIA Course Helper" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "popup-subtitle", children: "by BIA Community" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "popup-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "popup-content", children: [
      activeTab === "optimizer" && /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleOptimizer, {}),
      activeTab === "discover" && /* @__PURE__ */ jsxRuntimeExports.jsx(InterestSearch, {}),
      activeTab === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {})
    ] })
  ] });
}
