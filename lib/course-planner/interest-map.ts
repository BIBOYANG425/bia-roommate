...
const STOP_WORDS = new Set([
  ...
  'a', 'an', 'the', 'and', 'or', 'but', 'if', 'so', 'as', 'at',
  'in', 'on', 'of', 'to', 'for', 'by', 'with', 'from', 'about',
  'into', 'like', 'want', 'would', 'could', 'should', 'really',
  'very', 'also', 'just', 'some', 'more', 'most', 'other', 'than',
  'that', 'this', 'these', 'those', 'it', 'its', 'do', 'does',
  'did', 'have', 'has', 'had', 'not', 'no', 'can', 'will',
  'interested', 'enjoy', 'love', 'curious', 'explore', 'learn',
  'study', 'take', 'class', 'classes', 'course', 'courses',
  'stuff', 'things', 'thing', 'something', 'anything', 'everything',
  'lot', 'lots', 'much', 'many', 'few', 'little', 'big',
  // Search intent / filler words
  'find', 'search', 'looking', 'look', 'need', 'get', 'give',
  'show', 'tell', 'help', 'please', 'thanks', 'thank',
  // Qualifiers that aren't topical
  'easy', 'hard', 'difficult', 'simple', 'fun', 'boring', 'cool',
  'good', 'great', 'best', 'worst', 'nice', 'awesome', 'chill',
  'without', 'any', 'all', 'only', 'every', 'each', 'both',
  'new', 'old', 'same', 'different', 'possible',
  // Prepositions / conjunctions
  'between', 'during', 'before', 'after', 'through', 'over', 'under',
  'around', 'up', 'down', 'out', 'off', 'then', 'when', 'where',
  'how', 'what', 'which', 'who', 'why',
  // Course logistics
  'midterm', 'midterms', 'final', 'finals', 'exam', 'exams',
  'homework', 'assignment', 'grade', 'grading', 'unit', 'units',
  'credit', 'credits', 'semester', 'session', 'section',
  'professor', 'prof', 'instructor', 'teacher', 'ta',
])
...
export function tokenMatchScore(tokens: string[], targetText: string): { score: number; matched: string[] } {
  ...
  return { score: matched.length / tokens.length, matched: [...new Set(matched)] }
}
