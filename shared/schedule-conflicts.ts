// Framework-free time-slot parsing + overlap helpers shared by the web app, the
// Chrome extension, and the schedule solver. Owns the single implementation of
// USC day-code parsing and interval-overlap so every surface agrees on conflicts.
// lib/course-planner/conflicts.ts re-exports these for existing site consumers.
//
