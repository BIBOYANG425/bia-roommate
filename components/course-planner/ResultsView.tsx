...
export default function ResultsView({ courses, semester, prefs, onBack }: ResultsViewProps) {
  ...
  const [saveStatus, setSaveStatus] = useState<'idle' | 'naming' | 'saving' | 'saved' | 'error'>('idle')
      ...
      {active && (
        <>
          ...
          <div className="mt-6 pt-4 border-t-[2px] border-[var(--beige)]">
            ...
            ) : saveStatus === 'naming' || saveStatus === 'saving' || saveStatus === 'error' ? (
              <div
                className="p-4 border-[3px] border-[var(--black)]"
                style={{ background: 'var(--cream)' }}
              >
                <p className="font-display text-sm tracking-wider mb-3" style={{ color: 'var(--black)' }}>
                  NAME YOUR SCHEDULE
                </p>
                <input
                  type="text"
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => { setSaveStatus('idle'); setScheduleName('') }}
                  ...
                  <button
                    ...
                    style={{
                      background: saveStatus === 'error' ? 'var(--cardinal)' : 'var(--gold)',
