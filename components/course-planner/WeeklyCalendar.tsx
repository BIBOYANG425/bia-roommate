...
export default function WeeklyCalendar() {
  ...
  return (
    <div
      className="overflow-x-auto border-[3px] border-[var(--black)] relative"
      ...
      <div style={{ minWidth: "600px" }}>
        ...
        >
          <div
            ...
            style={{ borderRight: "3px solid var(--black)" }}
          >
            TIME
          </div>
          {DAYS.map((day) => (
            ...
            >
              ...
              {timeLabels.map((_, i) => (
                <div
                  key={i}
                  className={
                    i % 2 === 0 ? "calendar-row-line-hour" : "calendar-row-line"
                  }
        ...
        {blocks.length === 0 && (
          ...
          >
            <p
              ...
              style={{ color: "var(--mid)", opacity: 0.15 }}
            >
              ADD COURSES
            </p>
          </div>
