...
export default function SavedScheduleView({ name, semester, sections, avgRating, onBack }: SavedScheduleViewProps) {
  return (
    <div>
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: 'var(--mid)' }}>
              {semester} · {sections.length} sections · Avg RMP: <strong style={{ color: 'var(--black)' }}>{avgRating.toFixed(2)}</strong>
            </p>
          </div>
          <span
      ...
      {/* Calendar */}
      <div className="mb-4 border-[3px] border-[var(--black)] overflow-hidden" style={{ background: 'white' }}>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                ...
                <span className="text-xs font-display tracking-wider" style={{ color: '#1565C0' }}>
                  {s.section.type}
                </span>
              </div>
